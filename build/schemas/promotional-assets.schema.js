...
const basePromotionalAssetSchema = z.object({
    ...
    content: z.record(z.any()).refine((data) => Object.keys(data).length > 0, { message: "Content cannot be empty" }),
...
export const createPromotionalAssetSchema = basePromotionalAssetSchema.refine((data) => {
...
//# sourceMappingURL=promotional-assets.schema.js.map