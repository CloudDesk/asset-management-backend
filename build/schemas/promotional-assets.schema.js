...
const basePromotionalAssetSchema = z.object({
    ...
    content: z.union([
        z.record(z.any()).refine((data) => Object.keys(data).length > 0, { message: "Content object cannot be empty" }),
        z.array(z.any()).refine((data) => data.length > 0, { message: "Content array cannot be empty" })
    ]),
