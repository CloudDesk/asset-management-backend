...
If you didn't create an account, please ignore this email.
     ...
     */
    async sendAccountDeletionEmail(email, userName, userData) {
        try {
     ...
     */
    generateAccountDeletionEmailTemplate(userName, userData) {
        return `
      <!DOCTYPE html>
      <html lang="en">
      <head>
     ...
     */
    generateAccountDeletionEmailText(userName, userData) {
        return `
