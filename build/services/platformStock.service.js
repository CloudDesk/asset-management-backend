...
export class PlatformStockService {
     ...
     */
    async recalculatePlatformStockQuantities(productId, platform) {
        try {
            logger.debug({ productId, platform }, "Starting PlatformStock recalculation from scratch");
            ...
            logger.error({ error: error.message, productId, platform }, "Error recalculating PlatformStock quantities");
            throw error;
        }
    }
}
