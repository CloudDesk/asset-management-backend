...
export class RecaptchaEnterpriseService {
     ...
     */
    async createAssessment({ projectID = this.projectID, recaptchaKey = this.recaptchaKey, token, recaptchaAction, }) {
        try {
            if (!token) {
     ...
     */
    async verifyActionToken(token, action) {
        return this.createAssessment({
            token,
...
//# sourceMappingURL=recaptcha-enterprise.service.js.map