 ...
 */
function mapPostgresToSwaggerType(pgType, isNullable) {
    const property = {
        type: 'string'
    };
 ...
 */
export async function generateSwaggerSchema(modelName, schemaType = 'response') {
    try {
        // Check cache first
 ...
 */
export async function generateCRUDSchemas(modelName) {
    try {
...
//# sourceMappingURL=swaggerSchemaBuilder.js.map