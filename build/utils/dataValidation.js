 ...
 */
export function validateAndConvertData(data, schema) {
 ...
 */
function convertFieldValue(value, fieldSchema, fieldName) {
 ...
 */
function convertToInteger(value, fieldName) {
 ...
 */
function convertToString(value, fieldSchema, fieldName) {
    if (typeof value === 'string') {
 ...
 */
export function filterDataBySchema(data, schema) {
    if (!data || !schema || !schema.properties) {
        return data;
    }
    const filteredData = {};
 ...
 */
export function validateRequiredFields(data, schema) {
