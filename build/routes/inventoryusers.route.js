...
export async function inventoryUsersRoutes(fastify) {
        ...
        schema: {
            ...
            querystring: {
                ...
                properties: {
                    ...
                    role: { type: 'string', description: 'Filter by role (legacy)' },
        ...
        schema: {
            ...
            body: {
                ...
                properties: {
                    ...
                    roleid: { type: 'number', nullable: true, description: 'Role ID (foreign key to roles.id)' },
...
//# sourceMappingURL=inventoryusers.route.js.map