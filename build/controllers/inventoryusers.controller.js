...
import { createInventoryUsersSchema, updateInventoryUsersSchema, upsertInventoryUsersSchema, inventoryUsersParamsSchema } from '../schemas/inventoryusers.schema.js';
...
export class InventoryUsersController {
    inventoryUsersService = new InventoryUsersService();
    getInventoryUsers = asyncHandler(async (request, reply) => {
    ...
    createInventoryUser = asyncHandler(async (request, reply) => {
    ...
    updateInventoryUser = asyncHandler(async (request, reply) => {
        const { id } = inventoryUsersParamsSchema.parse(request.params);
...
//# sourceMappingURL=inventoryusers.controller.js.map