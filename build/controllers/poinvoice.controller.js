...
import { createPoinvoiceSchema, updatePoinvoiceSchema, upsertPoinvoiceSchema, poinvoiceParamsSchema } from '../schemas/poinvoice.schema.js';
...
export class PoinvoiceController {
    poinvoiceService = new PoinvoiceService();
    getPoinvoices = asyncHandler(async (request, reply) => {
    ...
    getPoinvoice = asyncHandler(async (request, reply) => {
    ...
    updatePoinvoice = asyncHandler(async (request, reply) => {
        const { id } = poinvoiceParamsSchema.parse(request.params);
