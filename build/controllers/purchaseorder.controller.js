...
export class PurchaseOrderController {
     ...
     */
    getPurchaseOrders = asyncHandler(async (request, reply) => {
     ...
     */
    updatePurchaseOrder = asyncHandler(async (request, reply) => {
        const { id } = purchaseOrderParamsSchema.parse(request.params);
     ...
     */
    deletePurchaseOrder = asyncHandler(async (request, reply) => {
        const { id } = purchaseOrderParamsSchema.parse(request.params);
     ...
     */
    upsertPurchaseOrder = asyncHandler(async (request, reply) => {
     ...
     */
    getPurchaseOrdersBySupplier = asyncHandler(async (request, reply) => {
     ...
     */
    updatePurchaseOrderStatus = asyncHandler(async (request, reply) => {
        const { id } = purchaseOrderParamsSchema.parse(request.params);
