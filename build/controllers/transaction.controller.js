...
import { createTransactionSchema, updateTransactionSchema, upsertTransactionSchema, transactionParamsSchema, transactionByIdParamsSchema } from '../schemas/transaction.schema.js';
...
export class TransactionController {
    ...
    getTransactions = asyncHandler(async (request, reply) => {
    ...
    getTransaction = asyncHandler(async (request, reply) => {
    ...
    getTransactionByTransactionId = asyncHandler(async (request, reply) => {
    ...
    getUserTransactions = asyncHandler(async (request, reply) => {
    ...
    createTransaction = asyncHandler(async (request, reply) => {
    ...
    updateTransaction = asyncHandler(async (request, reply) => {
        const { id } = transactionByIdParamsSchema.parse(request.params);
    ...
    updateTransactionByTransactionId = asyncHandler(async (request, reply) => {
        const { transactionid } = transactionParamsSchema.parse(request.params);
        const data = updateTransactionSchema.parse(request.body);
    ...
    deleteTransaction = asyncHandler(async (request, reply) => {
        const { id } = transactionByIdParamsSchema.parse(request.params);
        await this.transactionService.delete(id);
        const response = createSuccessResponse('Transaction deleted successfully', null);
        return reply.code(200).send(response);
    });
    deleteTransactionByTransactionId = asyncHandler(async (request, reply) => {
        const { transactionid } = transactionParamsSchema.parse(request.params);
        await this.transactionService.deleteByTransactionId(transactionid);
        const response = createSuccessResponse('Transaction deleted successfully', null);
        return reply.code(200).send(response);
    });
    upsertTransaction = asyncHandler(async (request, reply) => {
