...
export class ProductController {
    ...
    upsertProductWithFile = asyncHandler(async (request, reply) => {
    ...
    rearrangeProductImages = asyncHandler(async (request, reply) => {
        const { id } = productParamsSchema.parse(request.params);
        const requestBody = request.body;
    ...
    deleteProductImageUrls = asyncHandler(async (request, reply) => {
        const { id } = productParamsSchema.parse(request.params);
        const requestBody = request.body;
        // Validate request body structure
        if (!requestBody || typeof requestBody !== "object") {
    ...
    getProductsForPlatform = asyncHandler(async (request, reply) => {
    ...
    getProductForPlatform = asyncHandler(async (request, reply) => {
