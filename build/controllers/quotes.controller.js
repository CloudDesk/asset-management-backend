...
import { createQuotesSchema, updateQuotesSchema, upsertQuotesSchema, quotesParamsSchema } from '../schemas/quotes.schema.js';
...
export class QuotesController {
    ...
    getQuotes = asyncHandler(async (request, reply) => {
    ...
    getQuote = asyncHandler(async (request, reply) => {
    ...
    createQuote = asyncHandler(async (request, reply) => {
    ...
    updateQuote = asyncHandler(async (request, reply) => {
        const { id } = quotesParamsSchema.parse(request.params);
    ...
    getQuotesByPrNumber = asyncHandler(async (request, reply) => {
    ...
    getQuotesByStatus = asyncHandler(async (request, reply) => {
