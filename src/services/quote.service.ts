...
export module quoteService {
    export const getQuoteData = async (request: any) => {
        try {
    ...
    export const attachQuotefiles = async (quotedata: any) => {
        try {
            ...
            let result = await upsertQuotes(quotedata.body);
            return result;
        } catch (error) {
    ...
    export const attachGcpQuotefiles = async (quotedata: any) => {
        try {
            let querydata: string;
            let params: any[];
