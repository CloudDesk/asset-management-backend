...
export class PromotionActionsService {
  ...
  async create(data: CreatePromotionActionsInput & Record<string, any>) {
    try {
  ...
  async update(id: string, data: UpdatePromotionActionsInput & Record<string, any>) {
    try {
  ...
  async upsert(data: UpsertPromotionActionsInput & Record<string, any>) {
    try {
