...
export class QuotesService {
  ...
  async create(data: CreateQuotesInput & Record<string, any>) {
    try {
  ...
  async update(id: string, data: UpdateQuotesInput & Record<string, any>) {
    try {
  ...
  async upsert(data: UpsertQuotesInput & Record<string, any>) {
    try {
  ...
  async findByPrNumber(prnumber: string, page: number = 1, limit: number = 10) {
    try {
