...
export class RatingService {
  ...
  async getAverageRatingByProductId(productId: number): Promise<{ averageRating: number; totalRatings: number }> {
    try {
  ...
  async getRatingsByStarLevel(productId?: number): Promise<{ [key: number]: number }> {
    try {
