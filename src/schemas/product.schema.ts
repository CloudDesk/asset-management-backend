...
export const createProductSchema = z.object({
  ...
  name: z.string().min(1, 'Product name is required').max(1516, 'Product name too long'),
...
export const updateProductSchema = z.object({
  ...
  name: z.string().min(1, 'Product name is required').max(1516, 'Product name too long').optional(),
  puc: z.string().max(255, 'PUC too long').optional(), // Auto-generated by trigger
