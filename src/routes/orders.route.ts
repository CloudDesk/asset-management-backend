...
export async function ordersRoutes(fastify: FastifyInstance) {
      ...
      schema: {
        ...
        querystring: {
          ...
          properties: {
            ...
            ispaymentsucceed: {
              type: "string",
              description: "Filter by payment success status",
            },
  ...
  fastify.post(
    "/",
    {
      schema: {
        description:
          "Create a new order from single order object or cart items array",
        tags: ["Orders"],
        body: {
          oneOf: [
            {
              ...
              properties: {
                ...
                mode: {
                  type: "string",
                  description: "Payment mode: phonepe or cod",
                },
                delivereddate: {
                  type: "number",
            ...
            },
            {
              ...
              items: {
                ...
                properties: {
                  ...
                  orderamount: {
                    type: "number",
                    description: "Order amount for this item",
                  },
                  productamount: {
                    type: "number",
                    description: "Product amount for this item",
                  },
                  productcategory: {
                    type: "string",
        ...
        body: {
          ...
          properties: {
            status: {
              type: "string",
              description:
                "New status (delivered, cancelled, returned, dispatched, ready_to_dispatch, payment_failed, payment_success)",
            },
            additionalData: {
              type: "object",
      ...
      schema: {
        ...
        body: {
          ...
          properties: {
            id: {
              type: "number",
              description: "Order ID (for update, omit for create)",
            },
            userid: { type: "number", description: "User ID" },
            addressid: { type: "number", description: "Address ID" },
            orderamount: { type: "number", description: "Order amount" },
