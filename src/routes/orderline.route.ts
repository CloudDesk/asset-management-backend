...
export async function orderlineRoutes(fastify: FastifyInstance) {
      ...
      schema: {
        ...
        querystring: {
          ...
          properties: {
            ...
            productcolour: {
              type: "string",
              description: "Filter by product colour",
            },
            orderstatus: {
              type: "string",
            ...
            uniqueordderid: {
              type: "string",
              description: "Filter by unique order ID",
            },
            orderlinenumber: {
              type: "string",
              description: "Filter by orderline number",
            },
            deliveryfrom: {
              type: "string",
              description: "Filter by delivery from location",
            },
            ...
            productamount: {
              type: "string",
              description: "Filter by product amount",
            },
            orderamount: {
              type: "string",
                ...
                items: {
                  ...
                  properties: {
                    ...
                    readytodispatchdate: {
                      type: "number",
                      nullable: true,
                      description: "Ready to dispatch date",
                    },
                    delivereddate: {
                      type: "number",
                      nullable: true,
                    ...
                    deliveryfrom: {
                      type: "string",
                      nullable: true,
                      description: "Delivery from location",
                    },
                    location: {
                      type: "string",
                      nullable: true,
                    ...
                    paymentfaileddate: {
                      type: "number",
                      nullable: true,
                      description: "Payment failed date",
                    },
                    createddate: {
                      type: "number",
                      nullable: true,
      ...
      schema: {
        ...
        body: {
          ...
          properties: {
            ...
            readytodispatchdate: {
              type: "number",
              description: "Ready to dispatch date (timestamp)",
            },
            delivereddate: {
              type: "number",
              description: "Delivered date (timestamp)",
            },
            cancelleddate: {
              type: "number",
              description: "Cancelled date (timestamp)",
            },
            returneddate: {
              type: "number",
              description: "Returned date (timestamp)",
            },
            orderstatus: {
              type: "string",
              maxLength: 500,
            ...
            dispatcheddate: {
              type: "number",
              description: "Dispatched date (timestamp)",
            },
            ordereddate: {
              type: "number",
              description: "Ordered date (timestamp)",
            },
            paymentfaileddate: {
              type: "number",
              description: "Payment failed date (timestamp)",
            },
            createddate: {
              type: "number",
        ...
        body: {
          ...
          properties: {
            status: {
              type: "string",
              description:
                "New status (delivered, cancelled, returned, dispatched, ready_to_dispatch, payment_failed)",
            },
            additionalData: {
              type: "object",
              description: "Additional data to update",
            },
          },
          required: ["status"],
  ...
  fastify.patch(
    "/:id/cancel",
    {
      schema: {
        description:
          "Cancel an orderline and restore product quantities. If all orderlines in the order are cancelled, the order status will be updated to cancelled.",
        tags: ["Orderlines"],
        params: {
          type: "object",
          properties: {
      ...
      schema: {
        ...
        body: {
          ...
          properties: {
            id: {
              type: "number",
              description: "Orderline ID (for update, omit for create)",
            },
            orderid: { type: "number", description: "Order ID" },
            productid: { type: "number", description: "Product ID" },
            userid: { type: "number", description: "User ID" },
