...
export async function purchaseRequestRoutes(fastify: FastifyInstance) {
  ...
  fastify.get(
    ...
    purchaseRequestController.getPurchaseRequests.bind(
    ...
    async (request: any, reply: any) => {
      try {
        ...
        const purchaseRequest =
          await purchaseRequestController.purchaseRequestService.findById(id);
  ...
  fastify.post(
    ...
    purchaseRequestController.createPurchaseRequest.bind(
      purchaseRequestController
    )
  );
  ...
  fastify.put(
    ...
    async (request: any, reply: any) => {
      try {
        ...
        const purchaseRequest =
          await purchaseRequestController.purchaseRequestService.update(
            id,
            request.body
          );
  ...
  fastify.get(
    ...
    purchaseRequestController.getPurchaseRequestsByRequester.bind(
      purchaseRequestController
    )
  );
  ...
  fastify.get(
    ...
    purchaseRequestController.getPurchaseRequestsBySupplier.bind(
      purchaseRequestController
    )
  );
  ...
  fastify.put(
    ...
    purchaseRequestController.approvePurchaseRequest.bind(
      purchaseRequestController
    )
  );
  ...
  fastify.put(
    ...
    purchaseRequestController.rejectPurchaseRequest.bind(
      purchaseRequestController
    )
  );
}
