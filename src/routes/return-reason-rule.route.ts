...
const reasonRuleBodySchema = {
  ...
  properties: {
    ...
    stockunavailableresolution: { type: 'string', enum: resolutionEnum, nullable: true },
    pickuptriggermode: { type: 'string', enum: ['manual_admin'], default: 'manual_admin' },
    notifycustomeronstockfallback: { type: 'boolean' },
    reverseshippingchargebearer: { type: 'string', enum: ['nivaana'], nullable: true },
