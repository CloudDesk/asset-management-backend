      ...
      schema: {
        ...
        querystring: {
          ...
          properties: {
            ...
            organiccertified: {
              type: "string",
              description: "Filter by organic certified status",
            },
            supplierid: {
              type: "string",
            ...
            ingredients: {
              type: "string",
              description: "Filter by product ingredients",
            },
            usage: {
              type: "string",
            ...
            shelflife: {
              type: "string",
              description: "Filter by shelf life information",
            },
            ...
            scent_profile: {
              type: "string",
              description: "Filter by scent profile",
            },
            container_material: {
              type: "string",
              description: "Filter by container material",
            },
            candle_dimensions: {
              type: "string",
              description: "Filter by candle dimensions",
            },
            // Planter-specific filter fields
            planter_material: {
              type: "string",
              description: "Filter by planter material",
            },
            drainage_hole: {
              type: "string",
              description: "Filter by drainage hole (true/false)",
            },
            suitable_for: {
              type: "string",
              description: "Filter by suitable for plants",
            },
            planter_dimensions: {
              type: "string",
              description: "Filter by planter dimensions",
            },
            plant_included: {
              type: "string",
              description: "Filter by plant included (true/false)",
            },
            // Art-specific filter fields
            art_type: { type: "string", description: "Filter by art type" },
            frame_included: {
              type: "string",
              description: "Filter by frame included (true/false)",
            },
            art_dimensions: {
              type: "string",
              description: "Filter by art dimensions",
            },
            orientation: {
              type: "string",
              description: "Filter by art orientation",
            },
            artist_name: {
              type: "string",
  ...
  fastify.put(
    ...
    async (request: any, reply: any) => {
      try {
        ...
        // Update the product
        const product = await productController.productService.update(
          id,
          request.body
        );
        ...
        body: {
          ...
          properties: {
            ...
            url: {
              ...
              description:
                "Image URLs organized by size (will be merged with existing arrays)",
            },
        ...
        body: {
          ...
          properties: {
            large: {
              ...
              items: { type: "string" },
              description:
                "Reordered array of large image URLs (must contain exactly the same URLs as existing)",
            },
            medium: {
              type: "array",
              items: { type: "string" },
              description:
                "Reordered array of medium image URLs (must contain exactly the same URLs as existing)",
            },
            small: {
              type: "array",
              items: { type: "string" },
              description:
                "Reordered array of small image URLs (must contain exactly the same URLs as existing)",
            },
          },
