...
import { sendOtpSchema as otpSendSchema, verifyOtpSchema, SendOtpInput as OtpSendInput, VerifyOtpInput } from '../schemas/otp.schema.js';
...
export class SmsController {
   ...
   */
  sendOtpWithStorage = asyncHandler(
    async (
      ...
      if (!otpResult.success) {
        ...
        const errorResponse = createErrorResponse(
          ...
          otpResult.error || 'Could not generate OTP',
          statusCode
        );
      ...
      if (smsResult.success) {
        ...
        const errorResponse = createErrorResponse(
          ...
          smsResult.errorMessage || 'Could not send SMS',
          500
        );
    ...
    async (
      ...
      if (!otpResult.success) {
        ...
        const errorResponse = createErrorResponse(
          ...
          otpResult.error || 'Could not generate new OTP',
          statusCode
        );
