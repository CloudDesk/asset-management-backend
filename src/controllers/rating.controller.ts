...
export class RatingController {
  ...
  getRatings = asyncHandler(async (request: FastifyRequest<{ Querystring: Record<string, any> }>, reply: FastifyReply) => {
  ...
  getRating = asyncHandler(async (request: FastifyRequest<{ Params: RatingParams }>, reply: FastifyReply) => {
  ...
  createRating = asyncHandler(async (request: FastifyRequest, reply: FastifyReply) => {
  ...
  updateRating = asyncHandler(async (request: FastifyRequest<{ Params: RatingParams }>, reply: FastifyReply) => {
    const { id } = ratingParamsSchema.parse(request.params);
  ...
  deleteRating = asyncHandler(async (request: FastifyRequest<{ Params: RatingParams }>, reply: FastifyReply) => {
    const { id } = ratingParamsSchema.parse(request.params);
  ...
  upsertRating = asyncHandler(async (request: FastifyRequest, reply: FastifyReply) => {
  ...
  getRatingsByUserId = asyncHandler(async (request: FastifyRequest<{ Params: { userId: string } }>, reply: FastifyReply) => {
  ...
  getRatingsByProductId = asyncHandler(async (request: FastifyRequest<{ Params: { productId: string } }>, reply: FastifyReply) => {
  ...
  getRatingsByOrderId = asyncHandler(async (request: FastifyRequest<{ Params: { orderId: string } }>, reply: FastifyReply) => {
  ...
  getAverageRatingByProductId = asyncHandler(async (request: FastifyRequest<{ Params: { productId: string } }>, reply: FastifyReply) => {
    const productId = parseInt(request.params.productId);
  ...
  getRatingsByStarLevel = asyncHandler(async (request: FastifyRequest<{ Params?: { productId?: string }, Querystring?: { productId?: string } }>, reply: FastifyReply) => {
    ...
    if (request.params?.productId) {
      ...
      const queryProductId = (request.query as any).productId;
      if (queryProductId) {
