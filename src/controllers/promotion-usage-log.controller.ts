...
import { 
  createPromotionUsageLogSchema, 
  updatePromotionUsageLogSchema, 
  upsertPromotionUsageLogSchema,
...
export class PromotionUsageLogController {
  public promotionUsageLogService = new PromotionUsageLogService();

  getPromotionUsageLogs = asyncHandler(async (request: FastifyRequest<{ Querystring: Record<string, any> }>, reply: FastifyReply) => {
  ...
  getPromotionUsageLog = asyncHandler(async (request: FastifyRequest<{ Params: { id: string } }>, reply: FastifyReply) => {
  ...
  createPromotionUsageLog = asyncHandler(async (request: FastifyRequest<{ Body: CreatePromotionUsageLogInput }>, reply: FastifyReply) => {
  ...
  updatePromotionUsageLog = asyncHandler(async (request: FastifyRequest<{ Params: { id: string }; Body: UpdatePromotionUsageLogInput }>, reply: FastifyReply) => {
    const { id } = request.params;
  ...
  deletePromotionUsageLog = asyncHandler(async (request: FastifyRequest<{ Params: { id: string } }>, reply: FastifyReply) => {
    const { id } = request.params;
  ...
  upsertPromotionUsageLog = asyncHandler(async (request: FastifyRequest<{ Body: UpsertPromotionUsageLogInput }>, reply: FastifyReply) => {
