...
export class AddressController {
  ...
  getAddresses = asyncHandler(async (request: FastifyRequest<{ Querystring: Record<string, any> }>, reply: FastifyReply) => {
  ...
  getAddress = asyncHandler(async (request: FastifyRequest<{ Params: AddressParams }>, reply: FastifyReply) => {
  ...
  createAddress = asyncHandler(async (request: FastifyRequest, reply: FastifyReply) => {
  ...
  updateAddress = asyncHandler(async (request: FastifyRequest<{ Params: AddressParams }>, reply: FastifyReply) => {
    const { id } = addressParamsSchema.parse(request.params);
  ...
  deleteAddress = asyncHandler(async (request: FastifyRequest<{ Params: AddressParams }>, reply: FastifyReply) => {
    const { id } = addressParamsSchema.parse(request.params);
  ...
  upsertAddress = asyncHandler(async (request: FastifyRequest, reply: FastifyReply) => {
