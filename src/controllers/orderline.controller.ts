...
export class OrderlineController {
  ...
  getOrderlines = asyncHandler(
    async (
      ...
      const response = createSuccessResponse(
        "Orderlines retrieved successfully",
        formattedData
      );
  ...
  getOrderline = asyncHandler(
    async (
      request: FastifyRequest<{ Params: OrderlineParams }>,
      reply: FastifyReply
    ) => {
      ...
      const response = createSuccessResponse(
        "Orderline retrieved successfully",
        formatEntitiesForAPI([orderline], "orderline")[0]
      );
      return reply.code(200).send(response);
    }
  );

  getOrderlineByOrderlineNumber = asyncHandler(
    async (
      request: FastifyRequest<{ Params: { orderlinenumber: string } }>,
      reply: FastifyReply
    ) => {
      const { orderlinenumber } = request.params;

      const orderline = await this.orderlineService.findByOrderlineNumber(
        orderlinenumber
      );
  ...
  getOrderlinesByOrderId = asyncHandler(
    async (
      ...
      const orderlines = await this.orderlineService.findByOrderId(
        parseInt(orderid)
      );

      const response = createSuccessResponse(
        "Orderlines retrieved successfully",
        formatEntitiesForAPI(orderlines, "orderline")
      );
      return reply.code(200).send(response);
    }
  );

  createOrderline = asyncHandler(
  ...
  updateOrderline = asyncHandler(
    async (
      ...
      const response = createSuccessResponse(
        "Orderline updated successfully",
        formatEntitiesForAPI([orderline], "orderline")[0]
      );
      return reply.code(200).send(response);
    }
  ...
  updateOrderlineStatus = asyncHandler(
    async (
      ...
      const orderline = await this.orderlineService.updateOrderlineStatus(
        id,
        status,
        additionalData
      );
      ...
      const response = createSuccessResponse(
        "Orderline status updated successfully",
        formatEntitiesForAPI([orderline], "orderline")[0]
      );
      return reply.code(200).send(response);
    }
  ...
  bulkUpdateOrderlineStatus = asyncHandler(
    async (
      request: FastifyRequest<{
        Body: {
          orderlineIds: string[];
      ...
      const results = await this.orderlineService.bulkUpdateStatus(
        orderlineIds,
        status,
        additionalData
      );
  ...
  deleteOrderline = asyncHandler(
    async (
      ...
      const response = createSuccessResponse(
        "Orderline deleted successfully",
        null
      );
      return reply.code(200).send(response);
    }
